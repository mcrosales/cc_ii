...
if __name__ == '__main__':
    ...
    conf = SparkConf().setAppName('Mario Cesar Rosales Castro -> Practica 4 - Gradient Boosted Tree')  
    ...
    # Split the data into training and test sets (% held out for testing)
    (trainingData, testData) = dataset.randomSplit([0.6, 0.4])
